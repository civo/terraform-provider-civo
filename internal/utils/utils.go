...
// IsKnownAPIError checks if the error is a known civogo API error by comparing error strings
func IsKnownAPIError(err error) bool {
	knownErrors := []string{
		...
		"DatabaseIPFindError",
		"DatabaseKubernetesClusterInvalidError",
		"DatabaseKubernetesApplicationNotFoundError",
		"DatabaseKubernetesApplicationInvalidPlanError",
		"DatabaseKubernetesClusterDuplicateError",
		"DatabaseKubernetesClusterNotFoundError",
		"DatabaseKubernetesNodeNotFoundError",
		"DatabaseClusterPoolNotFoundError",
		"DatabaseClusterPoolInstanceNotFoundError",
		"DatabaseClusterPoolInstanceDeleteFailedError",
