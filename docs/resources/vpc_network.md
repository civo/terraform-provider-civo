...
description: |-
  Provides a Civo VPC network resource. This can be used to create, modify, and delete networks.
---
...
~> **Note:** This resource replaces the deprecated `civo_network` resource and uses the VPC-scoped API endpoints.

## Example Usage

```terraform
resource "civo_vpc_network" "custom_net" {
    label = "test_network"
}
```
...
```shell
# using ID
terraform import civo_vpc_network.custom_net b8ecd2ab-2267-4a5e-8692-cbf1d32583e3
```
