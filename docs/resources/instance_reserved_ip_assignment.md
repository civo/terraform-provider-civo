...
~> **Deprecated:** This resource is deprecated. Please use [`civo_vpc_reserved_ip_assignment`](vpc_reserved_ip_assignment.md) instead, which uses the VPC-scoped API endpoints.
